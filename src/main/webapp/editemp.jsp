...
<body>
    ...
    <div class="input-group">
			...
			<tr class="info">
				...
				<td><input  type="text" class="form-control" name="isAdmin" value=<%=employee.isAdmin()%>></td>
				<td><button type="hidden"  name="details" value="Edit" class="btn btn-primary" style="background-color: red;">
							<input type ="submit" name="details" value="Edit">
						</button></td>
